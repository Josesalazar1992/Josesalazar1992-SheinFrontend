...
const DeleteOrder: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const response = await fetch('http://localhost:5000/delete_order', {
                method: 'POST',
                headers: {
    ...
    return (
        <div>
            <h2>Borra una orden, (Los clientes y articulos de eliminaran)</h2>
            <form onSubmit={handleSubmit}>
                ...
                <button type="submit">Borrar Orden</button>
            </form>
